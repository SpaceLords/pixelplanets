...
func get_seed():
	return $GasLayers.material.get_shader_param("seed")
...
func get_material_properties():
	var m = $GasLayers.material
	var mr = $Ring.material
	return {
		"pixels": m.get_shader_param("pixels"),
		"rotation": m.get_shader_param("rotation"),
		"ring_rotation": mr.get_shader_param("rotation"),
		"seed": m.get_shader_param("seed"),
		"fbm_octaves": m.get_shader_param("OCTAVES"),
		"fbm_size": m.get_shader_param("size"),
		"ring_seed": mr.get_shader_param("seed"),
		"ring_fbm_octaves": mr.get_shader_param("OCTAVES"),
		"ring_fbm_size": mr.get_shader_param("size"),
		"dithered": m.get_shader_param("should_dither"),
		"cloud_curve": m.get_shader_param("cloud_curve"),
		"light_border1": m.get_shader_param("light_border_1"),
		"light_border2": m.get_shader_param("light_border_2"),
		"light_origin": m.get_shader_param("light_origin"),
		"bands": m.get_shader_param("bands"),
	}
