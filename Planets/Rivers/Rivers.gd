...
func get_material_properties():
	...
	return {
		"pixels": ml.get_shader_param("pixels"),
		"rotation": ml.get_shader_param("rotation"),
		"seed": ml.get_shader_param("seed"),
		...
		"dithered": ml.get_shader_param("should_dither"),
		"light_distance": ml.get_shader_param("light_border_1"),
		"light_distance2": ml.get_shader_param("light_border_2"),
