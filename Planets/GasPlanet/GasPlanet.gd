...
func get_seed():
	return $Cloud.material.get_shader_param("seed")
...
func get_material_properties():
	...
	return {
		...
		"cloud_cover": m.get_shader_param("cloud_cover"),
		"cloud_curve": m.get_shader_param("cloud_curve"),
		"light_border1": m.get_shader_param("light_border_1"),
		"light_border2": m.get_shader_param("light_border_1"),
