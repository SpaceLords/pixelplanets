...
func get_seed():
	return $Galaxy.material.get_shader_param("seed")
...
func get_material_properties():
	...
	return {
		...
		"tilt": m.get_shader_param("tilt"),
		"n_layers": m.get_shader_param("n_layers"),
		"layer_height": m.get_shader_param("layer_height"),
		"zoom": m.get_shader_param("zoom"),
		"n_colors": m.get_shader_param("n_colors"),
		"swirl": m.get_shader_param("swirl"),
	}
