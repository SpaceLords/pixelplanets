...
func get_seed():
	return $Disk.material.get_shader_param("seed")
...
func get_material_properties():
	var mb = $BlackHole.material
	var md = $Disk.material
	return {
		"pixels": mb.get_shader_param("pixels"),
		"radius": mb.get_shader_param("radius"),
		"light_width": mb.get_shader_param("light_width"),
		"rotation": md.get_shader_param("rotation"),
		"light_origin": md.get_shader_param("light_origin"),
		"seed": md.get_shader_param("seed"),
		"fbm_octaves": md.get_shader_param("OCTAVES"),
		"fbm_size": md.get_shader_param("size"),
		"ring_perspective": md.get_shader_param("ring_perspective"),
		"disk_width": md.get_shader_param("disk_width"),
		"dithered": md.get_shader_param("should_dither"),
	}
