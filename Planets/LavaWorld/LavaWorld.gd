...
func get_material_properties():
	...
	var mc = $Craters.material
	var ml = $LavaRivers.material
	...
	return {
		...
		"river_fbm_octaves": ml.get_shader_param("OCTAVES"),
		"river_fbm_size": ml.get_shader_param("size"),
		"river_cutoff": ml.get_shader_param("river_cutoff"),
		"crater_size": mc.get_shader_param("size"),
