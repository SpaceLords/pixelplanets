...
func get_seed():
	return $Star.material.get_shader_param("seed")
...
func get_material_properties():
	var ms = $Star.material
	var msb = $StarBackground.material
	var msf = $StarFlares.material
	
	return {
		"pixels": ms.get_shader_param("pixels"),
		"rotation": ms.get_shader_param("rotation"),
		"seed": ms.get_shader_param("seed"),
		"star_tiles": ms.get_shader_param("TILES"),
		"star_fbm_octaves": ms.get_shader_param("OCTAVES"),
		"star_fbm_size": ms.get_shader_param("size"),
		"starbackground_fbm_octaves": msb.get_shader_param("OCTAVES"),
		"starbackground_fbm_size": msb.get_shader_param("size"),
		"starbackground_circle_amount": msb.get_shader_param("circle_amount"),
		"starbackground_size": msb.get_shader_param("size"),
		"starflare_fbm_octaves": msf.get_shader_param("OCTAVES"),
		"starflare_fbm_size": msf.get_shader_param("size"),
		"starflare_circle_amount": msf.get_shader_param("circle_amount"),
		"starflare_circle_scale": msf.get_shader_param("circle_scale"),
		"storm_width": msf.get_shader_param("storm_width"),
		"storm_dither_width": msf.get_shader_param("storm_dither_width"),
		"dithered": ms.get_shader_param("should_dither"),
	}
