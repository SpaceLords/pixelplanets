...
func get_material_properties():
	var mw = $Water.material
	var ml = $Land.material
	var mc = $Cloud.material
	return {
		"pixels": mw.get_shader_param("pixels"),
		"rotation": mw.get_shader_param("rotation"),
		"seed": mw.get_shader_param("seed"),
		"water_fbm_octaves": mw.get_shader_param("OCTAVES"),
		"water_fbm_size": mw.get_shader_param("size"),
		"dithered": mw.get_shader_param("should_dither"),
		"land_fbm_octaves": ml.get_shader_param("OCTAVES"),
		"land_fbm_size": ml.get_shader_param("size"),
		"land_cutoff": ml.get_shader_param("land_cutoff"),
		...
		"light_border1": ml.get_shader_param("light_border_1"),
		"light_border2": ml.get_shader_param("light_border_1"),
		"light_origin": ml.get_shader_param("light_origin"),
	}
